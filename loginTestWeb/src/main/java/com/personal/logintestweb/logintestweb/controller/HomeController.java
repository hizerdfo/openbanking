package com.personal.logintestweb.logintestweb.controller;


import com.personal.logintestweb.logintestweb.repository.UserDTO;
...
import com.personal.logintestweb.logintestweb.service.KakaoAPI;
...
public class HomeController {
    ...
    public String kakaoLogin(@RequestParam("code") String code, HttpSession session) {
        ...
        if (userInfo.get("email") != null) {
            ...
            user.setEmail(email);
            System.out.println("데이터베이스 유저확인");
